...
public class IndexModel : PageModel
{
    ...
    public string DisplayNameFilter { get; set; } = string.Empty;

    [BindProperty(SupportsGet = true)]
    public string SessionIdFilter { get; set; } = string.Empty;

    [BindProperty(SupportsGet = true)]
    public string SubjectIdFilter { get; set; } = string.Empty;
